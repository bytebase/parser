...
// EnterExpressionWithEof is called when production expressionWithEof is entered.
func (s *BaseDorisParserListener) EnterExpressionWithEof(ctx *ExpressionWithEofContext) {}

// ExitExpressionWithEof is called when production expressionWithEof is exited.
func (s *BaseDorisParserListener) ExitExpressionWithEof(ctx *ExpressionWithEofContext) {}
...
// EnterDropMV is called when production dropMV is entered.
func (s *BaseDorisParserListener) EnterDropMV(ctx *DropMVContext) {}

// ExitDropMV is called when production dropMV is exited.
func (s *BaseDorisParserListener) ExitDropMV(ctx *DropMVContext) {}
...
// EnterAlterJob is called when production alterJob is entered.
func (s *BaseDorisParserListener) EnterAlterJob(ctx *AlterJobContext) {}

// ExitAlterJob is called when production alterJob is exited.
func (s *BaseDorisParserListener) ExitAlterJob(ctx *AlterJobContext) {}
...
// EnterOptSpecBranch is called when production optSpecBranch is entered.
func (s *BaseDorisParserListener) EnterOptSpecBranch(ctx *OptSpecBranchContext) {}

// ExitOptSpecBranch is called when production optSpecBranch is exited.
func (s *BaseDorisParserListener) ExitOptSpecBranch(ctx *OptSpecBranchContext) {}
...
// EnterMergeInto is called when production mergeInto is entered.
func (s *BaseDorisParserListener) EnterMergeInto(ctx *MergeIntoContext) {}

// ExitMergeInto is called when production mergeInto is exited.
func (s *BaseDorisParserListener) ExitMergeInto(ctx *MergeIntoContext) {}
...
// EnterMergeMatchedClause is called when production mergeMatchedClause is entered.
func (s *BaseDorisParserListener) EnterMergeMatchedClause(ctx *MergeMatchedClauseContext) {}

// ExitMergeMatchedClause is called when production mergeMatchedClause is exited.
func (s *BaseDorisParserListener) ExitMergeMatchedClause(ctx *MergeMatchedClauseContext) {}

// EnterMergeNotMatchedClause is called when production mergeNotMatchedClause is entered.
func (s *BaseDorisParserListener) EnterMergeNotMatchedClause(ctx *MergeNotMatchedClauseContext) {}

// ExitMergeNotMatchedClause is called when production mergeNotMatchedClause is exited.
func (s *BaseDorisParserListener) ExitMergeNotMatchedClause(ctx *MergeNotMatchedClauseContext) {}
...
// EnterCreateIndexCharFilter is called when production createIndexCharFilter is entered.
func (s *BaseDorisParserListener) EnterCreateIndexCharFilter(ctx *CreateIndexCharFilterContext) {}

// ExitCreateIndexCharFilter is called when production createIndexCharFilter is exited.
func (s *BaseDorisParserListener) ExitCreateIndexCharFilter(ctx *CreateIndexCharFilterContext) {}
...
// EnterAlterComputeGroup is called when production alterComputeGroup is entered.
func (s *BaseDorisParserListener) EnterAlterComputeGroup(ctx *AlterComputeGroupContext) {}

// ExitAlterComputeGroup is called when production alterComputeGroup is exited.
func (s *BaseDorisParserListener) ExitAlterComputeGroup(ctx *AlterComputeGroupContext) {}
...
// EnterAlterTableExecute is called when production alterTableExecute is entered.
func (s *BaseDorisParserListener) EnterAlterTableExecute(ctx *AlterTableExecuteContext) {}

// ExitAlterTableExecute is called when production alterTableExecute is exited.
func (s *BaseDorisParserListener) ExitAlterTableExecute(ctx *AlterTableExecuteContext) {}
...
// EnterDropIndexCharFilter is called when production dropIndexCharFilter is entered.
func (s *BaseDorisParserListener) EnterDropIndexCharFilter(ctx *DropIndexCharFilterContext) {}

// ExitDropIndexCharFilter is called when production dropIndexCharFilter is exited.
func (s *BaseDorisParserListener) ExitDropIndexCharFilter(ctx *DropIndexCharFilterContext) {}
...
// EnterShowCreateStorageVault is called when production showCreateStorageVault is entered.
func (s *BaseDorisParserListener) EnterShowCreateStorageVault(ctx *ShowCreateStorageVaultContext) {}

// ExitShowCreateStorageVault is called when production showCreateStorageVault is exited.
func (s *BaseDorisParserListener) ExitShowCreateStorageVault(ctx *ShowCreateStorageVaultContext) {}
...
// EnterShowIndexCharFilter is called when production showIndexCharFilter is entered.
func (s *BaseDorisParserListener) EnterShowIndexCharFilter(ctx *ShowIndexCharFilterContext) {}

// ExitShowIndexCharFilter is called when production showIndexCharFilter is exited.
func (s *BaseDorisParserListener) ExitShowIndexCharFilter(ctx *ShowIndexCharFilterContext) {}
...
// EnterWarmUpSelect is called when production warmUpSelect is entered.
func (s *BaseDorisParserListener) EnterWarmUpSelect(ctx *WarmUpSelectContext) {}

// ExitWarmUpSelect is called when production warmUpSelect is exited.
func (s *BaseDorisParserListener) ExitWarmUpSelect(ctx *WarmUpSelectContext) {}
...
// EnterWarmUpSingleTableRef is called when production warmUpSingleTableRef is entered.
func (s *BaseDorisParserListener) EnterWarmUpSingleTableRef(ctx *WarmUpSingleTableRefContext) {}

// ExitWarmUpSingleTableRef is called when production warmUpSingleTableRef is exited.
func (s *BaseDorisParserListener) ExitWarmUpSingleTableRef(ctx *WarmUpSingleTableRefContext) {}
...
// EnterAdminSetEncryptionRootKey is called when production adminSetEncryptionRootKey is entered.
func (s *BaseDorisParserListener) EnterAdminSetEncryptionRootKey(ctx *AdminSetEncryptionRootKeyContext) {
}

// ExitAdminSetEncryptionRootKey is called when production adminSetEncryptionRootKey is exited.
func (s *BaseDorisParserListener) ExitAdminSetEncryptionRootKey(ctx *AdminSetEncryptionRootKeyContext) {
}
...
// EnterAdminCreateClusterSnapshot is called when production adminCreateClusterSnapshot is entered.
func (s *BaseDorisParserListener) EnterAdminCreateClusterSnapshot(ctx *AdminCreateClusterSnapshotContext) {
}

// ExitAdminCreateClusterSnapshot is called when production adminCreateClusterSnapshot is exited.
func (s *BaseDorisParserListener) ExitAdminCreateClusterSnapshot(ctx *AdminCreateClusterSnapshotContext) {
}

// EnterAdminSetAutoClusterSnapshot is called when production adminSetAutoClusterSnapshot is entered.
func (s *BaseDorisParserListener) EnterAdminSetAutoClusterSnapshot(ctx *AdminSetAutoClusterSnapshotContext) {
}

// ExitAdminSetAutoClusterSnapshot is called when production adminSetAutoClusterSnapshot is exited.
func (s *BaseDorisParserListener) ExitAdminSetAutoClusterSnapshot(ctx *AdminSetAutoClusterSnapshotContext) {
}

// EnterAdminDropClusterSnapshot is called when production adminDropClusterSnapshot is entered.
func (s *BaseDorisParserListener) EnterAdminDropClusterSnapshot(ctx *AdminDropClusterSnapshotContext) {
}

// ExitAdminDropClusterSnapshot is called when production adminDropClusterSnapshot is exited.
func (s *BaseDorisParserListener) ExitAdminDropClusterSnapshot(ctx *AdminDropClusterSnapshotContext) {
}

// EnterAdminSetClusterSnapshotFeatureSwitch is called when production adminSetClusterSnapshotFeatureSwitch is entered.
func (s *BaseDorisParserListener) EnterAdminSetClusterSnapshotFeatureSwitch(ctx *AdminSetClusterSnapshotFeatureSwitchContext) {
}

// ExitAdminSetClusterSnapshotFeatureSwitch is called when production adminSetClusterSnapshotFeatureSwitch is exited.
func (s *BaseDorisParserListener) ExitAdminSetClusterSnapshotFeatureSwitch(ctx *AdminSetClusterSnapshotFeatureSwitchContext) {
}

// EnterAdminRotateTdeRootKey is called when production adminRotateTdeRootKey is entered.
func (s *BaseDorisParserListener) EnterAdminRotateTdeRootKey(ctx *AdminRotateTdeRootKeyContext) {}

// ExitAdminRotateTdeRootKey is called when production adminRotateTdeRootKey is exited.
func (s *BaseDorisParserListener) ExitAdminRotateTdeRootKey(ctx *AdminRotateTdeRootKeyContext) {}
...
// EnterAddPartitionFieldClause is called when production addPartitionFieldClause is entered.
func (s *BaseDorisParserListener) EnterAddPartitionFieldClause(ctx *AddPartitionFieldClauseContext) {}

// ExitAddPartitionFieldClause is called when production addPartitionFieldClause is exited.
func (s *BaseDorisParserListener) ExitAddPartitionFieldClause(ctx *AddPartitionFieldClauseContext) {}

// EnterDropPartitionFieldClause is called when production dropPartitionFieldClause is entered.
func (s *BaseDorisParserListener) EnterDropPartitionFieldClause(ctx *DropPartitionFieldClauseContext) {
}

// ExitDropPartitionFieldClause is called when production dropPartitionFieldClause is exited.
func (s *BaseDorisParserListener) ExitDropPartitionFieldClause(ctx *DropPartitionFieldClauseContext) {
}

// EnterReplacePartitionFieldClause is called when production replacePartitionFieldClause is entered.
func (s *BaseDorisParserListener) EnterReplacePartitionFieldClause(ctx *ReplacePartitionFieldClauseContext) {
}

// ExitReplacePartitionFieldClause is called when production replacePartitionFieldClause is exited.
func (s *BaseDorisParserListener) ExitReplacePartitionFieldClause(ctx *ReplacePartitionFieldClauseContext) {
}
...
// EnterPartitionTransformWithArgs is called when production partitionTransformWithArgs is entered.
func (s *BaseDorisParserListener) EnterPartitionTransformWithArgs(ctx *PartitionTransformWithArgsContext) {
}

// ExitPartitionTransformWithArgs is called when production partitionTransformWithArgs is exited.
func (s *BaseDorisParserListener) ExitPartitionTransformWithArgs(ctx *PartitionTransformWithArgsContext) {
}

// EnterPartitionTransformWithColumn is called when production partitionTransformWithColumn is entered.
func (s *BaseDorisParserListener) EnterPartitionTransformWithColumn(ctx *PartitionTransformWithColumnContext) {
}

// ExitPartitionTransformWithColumn is called when production partitionTransformWithColumn is exited.
func (s *BaseDorisParserListener) ExitPartitionTransformWithColumn(ctx *PartitionTransformWithColumnContext) {
}

// EnterPartitionTransformIdentity is called when production partitionTransformIdentity is entered.
func (s *BaseDorisParserListener) EnterPartitionTransformIdentity(ctx *PartitionTransformIdentityContext) {
}

// ExitPartitionTransformIdentity is called when production partitionTransformIdentity is exited.
func (s *BaseDorisParserListener) ExitPartitionTransformIdentity(ctx *PartitionTransformIdentityContext) {
}
...
// EnterDistributeType is called when production distributeType is entered.
func (s *BaseDorisParserListener) EnterDistributeType(ctx *DistributeTypeContext) {}

// ExitDistributeType is called when production distributeType is exited.
func (s *BaseDorisParserListener) ExitDistributeType(ctx *DistributeTypeContext) {}

// EnterSkewHint is called when production skewHint is entered.
func (s *BaseDorisParserListener) EnterSkewHint(ctx *SkewHintContext) {}

// ExitSkewHint is called when production skewHint is exited.
func (s *BaseDorisParserListener) ExitSkewHint(ctx *SkewHintContext) {}

// EnterConstantList is called when production constantList is entered.
func (s *BaseDorisParserListener) EnterConstantList(ctx *ConstantListContext) {}

// ExitConstantList is called when production constantList is exited.
func (s *BaseDorisParserListener) ExitConstantList(ctx *ConstantListContext) {}
...
// EnterExpressionWithOrder is called when production expressionWithOrder is entered.
func (s *BaseDorisParserListener) EnterExpressionWithOrder(ctx *ExpressionWithOrderContext) {}

// ExitExpressionWithOrder is called when production expressionWithOrder is exited.
func (s *BaseDorisParserListener) ExitExpressionWithOrder(ctx *ExpressionWithOrderContext) {}
...
func (s *BaseDorisParserListener) EnterHintName(ctx *HintNameContext) {}

// ExitHintName is called when production hintName is exited.
func (s *BaseDorisParserListener) ExitHintName(ctx *HintNameContext) {}
...
func (s *BaseDorisParserListener) ExitFuncExpression(ctx *FuncExpressionContext) {}
...
func (s *BaseDorisParserListener) EnterSubstring(ctx *SubstringContext) {}

// ExitSubstring is called when production substring is exited.
func (s *BaseDorisParserListener) ExitSubstring(ctx *SubstringContext) {}
...
func (s *BaseDorisParserListener) EnterTrim(ctx *TrimContext) {}

// ExitTrim is called when production trim is exited.
func (s *BaseDorisParserListener) ExitTrim(ctx *TrimContext) {}
...
// EnterGroupConcat is called when production groupConcat is entered.
func (s *BaseDorisParserListener) EnterGroupConcat(ctx *GroupConcatContext) {}

// ExitGroupConcat is called when production groupConcat is exited.
func (s *BaseDorisParserListener) ExitGroupConcat(ctx *GroupConcatContext) {}
...
// EnterGetFormatFunction is called when production getFormatFunction is entered.
func (s *BaseDorisParserListener) EnterGetFormatFunction(ctx *GetFormatFunctionContext) {}

// ExitGetFormatFunction is called when production getFormatFunction is exited.
func (s *BaseDorisParserListener) ExitGetFormatFunction(ctx *GetFormatFunctionContext) {}
...
func (s *BaseDorisParserListener) EnterPosition(ctx *PositionContext) {}

// ExitPosition is called when production position is exited.
func (s *BaseDorisParserListener) ExitPosition(ctx *PositionContext) {}

// EnterTryCast is called when production tryCast is entered.
func (s *BaseDorisParserListener) EnterTryCast(ctx *TryCastContext) {}

// ExitTryCast is called when production tryCast is exited.
func (s *BaseDorisParserListener) ExitTryCast(ctx *TryCastContext) {}
...
// EnterVarbinaryLiteral is called when production varbinaryLiteral is entered.
func (s *BaseDorisParserListener) EnterVarbinaryLiteral(ctx *VarbinaryLiteralContext) {}

// ExitVarbinaryLiteral is called when production varbinaryLiteral is exited.
func (s *BaseDorisParserListener) ExitVarbinaryLiteral(ctx *VarbinaryLiteralContext) {}
...
// EnterVariantPredefinedFields is called when production variantPredefinedFields is entered.
func (s *BaseDorisParserListener) EnterVariantPredefinedFields(ctx *VariantPredefinedFieldsContext) {}

// ExitVariantPredefinedFields is called when production variantPredefinedFields is exited.
func (s *BaseDorisParserListener) ExitVariantPredefinedFields(ctx *VariantPredefinedFieldsContext) {}
...
func (s *BaseDorisParserListener) EnterVariant(ctx *VariantContext) {}

// ExitVariant is called when production variant is exited.
func (s *BaseDorisParserListener) ExitVariant(ctx *VariantContext) {}

// EnterVariantSubColTypeList is called when production variantSubColTypeList is entered.
func (s *BaseDorisParserListener) EnterVariantSubColTypeList(ctx *VariantSubColTypeListContext) {}

// ExitVariantSubColTypeList is called when production variantSubColTypeList is exited.
func (s *BaseDorisParserListener) ExitVariantSubColTypeList(ctx *VariantSubColTypeListContext) {}

// EnterVariantSubColType is called when production variantSubColType is entered.
func (s *BaseDorisParserListener) EnterVariantSubColType(ctx *VariantSubColTypeContext) {}

// ExitVariantSubColType is called when production variantSubColType is exited.
func (s *BaseDorisParserListener) ExitVariantSubColType(ctx *VariantSubColTypeContext) {}

// EnterVariantSubColMatchType is called when production variantSubColMatchType is entered.
func (s *BaseDorisParserListener) EnterVariantSubColMatchType(ctx *VariantSubColMatchTypeContext) {}

// ExitVariantSubColMatchType is called when production variantSubColMatchType is exited.
func (s *BaseDorisParserListener) ExitVariantSubColMatchType(ctx *VariantSubColMatchTypeContext) {}
