...
type DorisParserListener interface {
	...
	// EnterExpressionWithEof is called when entering the expressionWithEof production.
	EnterExpressionWithEof(c *ExpressionWithEofContext)
	...
	// EnterDropMV is called when entering the dropMV production.
	EnterDropMV(c *DropMVContext)
	...
	// EnterAlterJob is called when entering the alterJob production.
	EnterAlterJob(c *AlterJobContext)
	...
	// EnterOptSpecBranch is called when entering the optSpecBranch production.
	EnterOptSpecBranch(c *OptSpecBranchContext)
	...
	// EnterMergeInto is called when entering the mergeInto production.
	EnterMergeInto(c *MergeIntoContext)
	...
	// EnterMergeMatchedClause is called when entering the mergeMatchedClause production.
	EnterMergeMatchedClause(c *MergeMatchedClauseContext)

	// EnterMergeNotMatchedClause is called when entering the mergeNotMatchedClause production.
	EnterMergeNotMatchedClause(c *MergeNotMatchedClauseContext)
	...
	// EnterCreateIndexCharFilter is called when entering the createIndexCharFilter production.
	EnterCreateIndexCharFilter(c *CreateIndexCharFilterContext)
	...
	// EnterAlterComputeGroup is called when entering the alterComputeGroup production.
	EnterAlterComputeGroup(c *AlterComputeGroupContext)
	...
	// EnterAlterTableExecute is called when entering the alterTableExecute production.
	EnterAlterTableExecute(c *AlterTableExecuteContext)
	...
	// EnterDropIndexCharFilter is called when entering the dropIndexCharFilter production.
	EnterDropIndexCharFilter(c *DropIndexCharFilterContext)
	...
	// EnterShowCreateStorageVault is called when entering the showCreateStorageVault production.
	EnterShowCreateStorageVault(c *ShowCreateStorageVaultContext)
	...
	// EnterShowIndexCharFilter is called when entering the showIndexCharFilter production.
	EnterShowIndexCharFilter(c *ShowIndexCharFilterContext)
	...
	// EnterWarmUpSelect is called when entering the warmUpSelect production.
	EnterWarmUpSelect(c *WarmUpSelectContext)
	...
	// EnterWarmUpSingleTableRef is called when entering the warmUpSingleTableRef production.
	EnterWarmUpSingleTableRef(c *WarmUpSingleTableRefContext)
	...
	// EnterAdminSetEncryptionRootKey is called when entering the adminSetEncryptionRootKey production.
	EnterAdminSetEncryptionRootKey(c *AdminSetEncryptionRootKeyContext)
	...
	// EnterAdminCreateClusterSnapshot is called when entering the adminCreateClusterSnapshot production.
	EnterAdminCreateClusterSnapshot(c *AdminCreateClusterSnapshotContext)

	// EnterAdminSetAutoClusterSnapshot is called when entering the adminSetAutoClusterSnapshot production.
	EnterAdminSetAutoClusterSnapshot(c *AdminSetAutoClusterSnapshotContext)

	// EnterAdminDropClusterSnapshot is called when entering the adminDropClusterSnapshot production.
	EnterAdminDropClusterSnapshot(c *AdminDropClusterSnapshotContext)

	// EnterAdminSetClusterSnapshotFeatureSwitch is called when entering the adminSetClusterSnapshotFeatureSwitch production.
	EnterAdminSetClusterSnapshotFeatureSwitch(c *AdminSetClusterSnapshotFeatureSwitchContext)

	// EnterAdminRotateTdeRootKey is called when entering the adminRotateTdeRootKey production.
	EnterAdminRotateTdeRootKey(c *AdminRotateTdeRootKeyContext)
	...
	// EnterAddPartitionFieldClause is called when entering the addPartitionFieldClause production.
	EnterAddPartitionFieldClause(c *AddPartitionFieldClauseContext)

	// EnterDropPartitionFieldClause is called when entering the dropPartitionFieldClause production.
	EnterDropPartitionFieldClause(c *DropPartitionFieldClauseContext)

	// EnterReplacePartitionFieldClause is called when entering the replacePartitionFieldClause production.
	...
	// EnterPartitionTransformWithArgs is called when entering the partitionTransformWithArgs production.
	EnterPartitionTransformWithArgs(c *PartitionTransformWithArgsContext)

	// EnterPartitionTransformWithColumn is called when entering the partitionTransformWithColumn production.
	EnterPartitionTransformWithColumn(c *PartitionTransformWithColumnContext)

	// EnterPartitionTransformIdentity is called when entering the partitionTransformIdentity production.
	EnterPartitionTransformIdentity(c *PartitionTransformIdentityContext)
	...
	// EnterDistributeType is called when entering the distributeType production.
	EnterDistributeType(c *DistributeTypeContext)

	// EnterSkewHint is called when entering the skewHint production.
	EnterSkewHint(c *SkewHintContext)
	...
	// EnterExpressionWithOrder is called when entering the expressionWithOrder production.
	EnterExpressionWithOrder(c *ExpressionWithOrderContext)
	...
	// EnterGroupConcat is called when entering the groupConcat production.
	EnterGroupConcat(c *GroupConcatContext)
	...
	// EnterGetFormatFunction is called when entering the getFormatFunction production.
	EnterGetFormatFunction(c *GetFormatFunctionContext)
	...
	// EnterTryCast is called when entering the tryCast production.
	EnterTryCast(c *TryCastContext)
	...
	// EnterVarbinaryLiteral is called when entering the varbinaryLiteral production.
	EnterVarbinaryLiteral(c *VarbinaryLiteralContext)
	...
	// EnterVariantPredefinedFields is called when entering the variantPredefinedFields production.
	EnterVariantPredefinedFields(c *VariantPredefinedFieldsContext)
	...
	// EnterVariantSubColTypeList is called when entering the variantSubColTypeList production.
	EnterVariantSubColTypeList(c *VariantSubColTypeListContext)

	// EnterVariantSubColType is called when entering the variantSubColType production.
	EnterVariantSubColType(c *VariantSubColTypeContext)

	// EnterVariantSubColMatchType is called when entering the variantSubColMatchType production.
	EnterVariantSubColMatchType(c *VariantSubColMatchTypeContext)
	...
	// ExitExpressionWithEof is called when exiting the expressionWithEof production.
	ExitExpressionWithEof(c *ExpressionWithEofContext)
	...
	// ExitDropMV is called when exiting the dropMV production.
	ExitDropMV(c *DropMVContext)
	...
	// ExitAlterJob is called when exiting the alterJob production.
	ExitAlterJob(c *AlterJobContext)
	...
	// ExitOptSpecBranch is called when exiting the optSpecBranch production.
	ExitOptSpecBranch(c *OptSpecBranchContext)
	...
	// ExitMergeInto is called when exiting the mergeInto production.
	ExitMergeInto(c *MergeIntoContext)
	...
	// ExitMergeMatchedClause is called when exiting the mergeMatchedClause production.
	ExitMergeMatchedClause(c *MergeMatchedClauseContext)

	// ExitMergeNotMatchedClause is called when exiting the mergeNotMatchedClause production.
	ExitMergeNotMatchedClause(c *MergeNotMatchedClauseContext)
	...
	// ExitCreateIndexCharFilter is called when exiting the createIndexCharFilter production.
	ExitCreateIndexCharFilter(c *CreateIndexCharFilterContext)
	...
	// ExitAlterComputeGroup is called when exiting the alterComputeGroup production.
	ExitAlterComputeGroup(c *AlterComputeGroupContext)
	...
	// ExitAlterTableExecute is called when exiting the alterTableExecute production.
	ExitAlterTableExecute(c *AlterTableExecuteContext)
	...
	// ExitDropIndexCharFilter is called when exiting the dropIndexCharFilter production.
	ExitDropIndexCharFilter(c *DropIndexCharFilterContext)
	...
	// ExitShowCreateStorageVault is called when exiting the showCreateStorageVault production.
	ExitShowCreateStorageVault(c *ShowCreateStorageVaultContext)
	...
	// ExitShowIndexCharFilter is called when exiting the showIndexCharFilter production.
	ExitShowIndexCharFilter(c *ShowIndexCharFilterContext)
	...
	// ExitWarmUpSelect is called when exiting the warmUpSelect production.
	ExitWarmUpSelect(c *WarmUpSelectContext)
	...
	// ExitWarmUpSingleTableRef is called when exiting the warmUpSingleTableRef production.
	ExitWarmUpSingleTableRef(c *WarmUpSingleTableRefContext)
	...
	// ExitAdminSetEncryptionRootKey is called when exiting the adminSetEncryptionRootKey production.
	ExitAdminSetEncryptionRootKey(c *AdminSetEncryptionRootKeyContext)
	...
	// ExitAdminCreateClusterSnapshot is called when exiting the adminCreateClusterSnapshot production.
	ExitAdminCreateClusterSnapshot(c *AdminCreateClusterSnapshotContext)

	// ExitAdminSetAutoClusterSnapshot is called when exiting the adminSetAutoClusterSnapshot production.
	ExitAdminSetAutoClusterSnapshot(c *AdminSetAutoClusterSnapshotContext)

	// ExitAdminDropClusterSnapshot is called when exiting the adminDropClusterSnapshot production.
	ExitAdminDropClusterSnapshot(c *AdminDropClusterSnapshotContext)

	// ExitAdminSetClusterSnapshotFeatureSwitch is called when exiting the adminSetClusterSnapshotFeatureSwitch production.
	ExitAdminSetClusterSnapshotFeatureSwitch(c *AdminSetClusterSnapshotFeatureSwitchContext)

	// ExitAdminRotateTdeRootKey is called when exiting the adminRotateTdeRootKey production.
	ExitAdminRotateTdeRootKey(c *AdminRotateTdeRootKeyContext)
	...
	// ExitAddPartitionFieldClause is called when exiting the addPartitionFieldClause production.
	ExitAddPartitionFieldClause(c *AddPartitionFieldClauseContext)

	// ExitDropPartitionFieldClause is called when exiting the dropPartitionFieldClause production.
	ExitDropPartitionFieldClause(c *DropPartitionFieldClauseContext)

	// ExitReplacePartitionFieldClause is called when exiting the replacePartitionFieldClause production.
	...
	// ExitPartitionTransformWithArgs is called when exiting the partitionTransformWithArgs production.
	ExitPartitionTransformWithArgs(c *PartitionTransformWithArgsContext)

	// ExitPartitionTransformWithColumn is called when exiting the partitionTransformWithColumn production.
	ExitPartitionTransformWithColumn(c *PartitionTransformWithColumnContext)

	// ExitPartitionTransformIdentity is called when exiting the partitionTransformIdentity production.
	ExitPartitionTransformIdentity(c *PartitionTransformIdentityContext)
	...
	// ExitDistributeType is called when exiting the distributeType production.
	ExitDistributeType(c *DistributeTypeContext)

	// ExitSkewHint is called when exiting the skewHint production.
	ExitSkewHint(c *SkewHintContext)
	...
	// ExitExpressionWithOrder is called when exiting the expressionWithOrder production.
	ExitExpressionWithOrder(c *ExpressionWithOrderContext)
	...
	// ExitGroupConcat is called when exiting the groupConcat production.
	ExitGroupConcat(c *GroupConcatContext)
	...
	// ExitGetFormatFunction is called when exiting the getFormatFunction production.
	ExitGetFormatFunction(c *GetFormatFunctionContext)
	...
	// ExitTryCast is called when exiting the tryCast production.
	ExitTryCast(c *TryCastContext)
	...
	// ExitVarbinaryLiteral is called when exiting the varbinaryLiteral production.
	ExitVarbinaryLiteral(c *VarbinaryLiteralContext)
	...
	// ExitVariantPredefinedFields is called when exiting the variantPredefinedFields production.
	ExitVariantPredefinedFields(c *VariantPredefinedFieldsContext)
	...
	// ExitVariantSubColTypeList is called when exiting the variantSubColTypeList production.
	ExitVariantSubColTypeList(c *VariantSubColTypeListContext)

	// ExitVariantSubColType is called when exiting the variantSubColType production.
	ExitVariantSubColType(c *VariantSubColTypeContext)

	// ExitVariantSubColMatchType is called when exiting the variantSubColMatchType production.
	ExitVariantSubColMatchType(c *VariantSubColMatchTypeContext)
