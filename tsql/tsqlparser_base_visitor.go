...
func (v *BaseTSqlParserVisitor) VisitCreate_spatial_index(ctx *Create_spatial_indexContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseTSqlParserVisitor) VisitSpatial_tessellation_scheme(ctx *Spatial_tessellation_schemeContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseTSqlParserVisitor) VisitSpatial_index_options(ctx *Spatial_index_optionsContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseTSqlParserVisitor) VisitSpatial_index_option(ctx *Spatial_index_optionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseTSqlParserVisitor) VisitSigned_decimal(ctx *Signed_decimalContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseTSqlParserVisitor) VisitSpatial_grid_level(ctx *Spatial_grid_levelContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseTSqlParserVisitor) VisitSpatial_grid_density(ctx *Spatial_grid_densityContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseTSqlParserVisitor) VisitColumn_name_with_order(ctx *Column_name_with_orderContext) interface{} {
	return v.VisitChildren(ctx)
}
