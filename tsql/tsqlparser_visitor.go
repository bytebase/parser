...
type TSqlParserVisitor interface {
	...
	// Visit a parse tree produced by TSqlParser#create_spatial_index.
	VisitCreate_spatial_index(ctx *Create_spatial_indexContext) interface{}

	// Visit a parse tree produced by TSqlParser#spatial_tessellation_scheme.
	VisitSpatial_tessellation_scheme(ctx *Spatial_tessellation_schemeContext) interface{}

	// Visit a parse tree produced by TSqlParser#spatial_index_options.
	VisitSpatial_index_options(ctx *Spatial_index_optionsContext) interface{}

	// Visit a parse tree produced by TSqlParser#spatial_index_option.
	VisitSpatial_index_option(ctx *Spatial_index_optionContext) interface{}

	// Visit a parse tree produced by TSqlParser#signed_decimal.
	VisitSigned_decimal(ctx *Signed_decimalContext) interface{}

	// Visit a parse tree produced by TSqlParser#spatial_grid_level.
	VisitSpatial_grid_level(ctx *Spatial_grid_levelContext) interface{}

	// Visit a parse tree produced by TSqlParser#spatial_grid_density.
	VisitSpatial_grid_density(ctx *Spatial_grid_densityContext) interface{}
	...
	// Visit a parse tree produced by TSqlParser#column_name_with_order.
	VisitColumn_name_with_order(ctx *Column_name_with_orderContext) interface{}
