...
// EnterCreate_spatial_index is called when production create_spatial_index is entered.
func (s *BaseTSqlParserListener) EnterCreate_spatial_index(ctx *Create_spatial_indexContext) {}

// ExitCreate_spatial_index is called when production create_spatial_index is exited.
func (s *BaseTSqlParserListener) ExitCreate_spatial_index(ctx *Create_spatial_indexContext) {}

// EnterSpatial_tessellation_scheme is called when production spatial_tessellation_scheme is entered.
func (s *BaseTSqlParserListener) EnterSpatial_tessellation_scheme(ctx *Spatial_tessellation_schemeContext) {
}

// ExitSpatial_tessellation_scheme is called when production spatial_tessellation_scheme is exited.
func (s *BaseTSqlParserListener) ExitSpatial_tessellation_scheme(ctx *Spatial_tessellation_schemeContext) {
}

// EnterSpatial_index_options is called when production spatial_index_options is entered.
func (s *BaseTSqlParserListener) EnterSpatial_index_options(ctx *Spatial_index_optionsContext) {}

// ExitSpatial_index_options is called when production spatial_index_options is exited.
func (s *BaseTSqlParserListener) ExitSpatial_index_options(ctx *Spatial_index_optionsContext) {}

// EnterSpatial_index_option is called when production spatial_index_option is entered.
func (s *BaseTSqlParserListener) EnterSpatial_index_option(ctx *Spatial_index_optionContext) {}

// ExitSpatial_index_option is called when production spatial_index_option is exited.
func (s *BaseTSqlParserListener) ExitSpatial_index_option(ctx *Spatial_index_optionContext) {}

// EnterSigned_decimal is called when production signed_decimal is entered.
func (s *BaseTSqlParserListener) EnterSigned_decimal(ctx *Signed_decimalContext) {}

// ExitSigned_decimal is called when production signed_decimal is exited.
func (s *BaseTSqlParserListener) ExitSigned_decimal(ctx *Signed_decimalContext) {}

// EnterSpatial_grid_level is called when production spatial_grid_level is entered.
func (s *BaseTSqlParserListener) EnterSpatial_grid_level(ctx *Spatial_grid_levelContext) {}

// ExitSpatial_grid_level is called when production spatial_grid_level is exited.
func (s *BaseTSqlParserListener) ExitSpatial_grid_level(ctx *Spatial_grid_levelContext) {}

// EnterSpatial_grid_density is called when production spatial_grid_density is entered.
func (s *BaseTSqlParserListener) EnterSpatial_grid_density(ctx *Spatial_grid_densityContext) {}

// ExitSpatial_grid_density is called when production spatial_grid_density is exited.
func (s *BaseTSqlParserListener) ExitSpatial_grid_density(ctx *Spatial_grid_densityContext) {}
...
// EnterColumn_name_with_order is called when production column_name_with_order is entered.
func (s *BaseTSqlParserListener) EnterColumn_name_with_order(ctx *Column_name_with_orderContext) {}

// ExitColumn_name_with_order is called when production column_name_with_order is exited.
func (s *BaseTSqlParserListener) ExitColumn_name_with_order(ctx *Column_name_with_orderContext) {}
